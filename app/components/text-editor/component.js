...
import registerKeyCommands from './key-commands';
...
import createComponentCard from './create-component-card';
...
export default Component.extend({
    ...
    mobiledoc: computed({
      get() {
        ...
        try {
          return JSON.parse(get(this, 'value')) || BLANK_DOC;
        } catch (e) {
          return BLANK_DOC;
        }
      }
    ...
    editorOptions: computed(function () {
        ...
        cards = [
          ...(this.embeds || []).map((type) => createComponentCard(type))
        ].concat(cards);
    ...
    init() {
        ...
        if (!mobiledoc) {
            mobiledoc = BLANK_DOC;
            this.onchange(JSON.stringify(mobiledoc));
        }
    ...
    postDidChange(editor) {
        ...
        this.onchange(JSON.stringify(updatedMobiledoc));
